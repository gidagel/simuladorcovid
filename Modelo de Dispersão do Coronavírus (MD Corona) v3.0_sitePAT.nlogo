...
"" ""
PENS
"infectado" 1 0 -2674135 true "" "plot (count turtles with [ sick? ]) * 100 / número-de-pessoas "
"imune" 1 0 -7500403 true "" "plot (count turtles with [ immune? ]) * 100 / número-de-pessoas "
...
230
55
1º PASSO: insira o IPC e a densidade da localidade a ser simulada, de acordo com a Tabela 1: Índice de Proteção ao Covid-19
12
0
1
...
230
225
Insira a % de confinados (população em isolamento social) do local. O índice de confinamento pode ser alterado durante a simulação.
12
0
1
@#$#@#$#@
